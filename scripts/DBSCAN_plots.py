...
info_results = pd.read_feather(cwd + "\\cluster_results\\info.feather")

fig = px.scatter(info_results, x="SocialmediatrustQ1", y="CanadaQ_1", color="labels",
...
politics_results = pd.read_feather(cwd + "\\cluster_results\\politics.feather")

fig = px.scatter(politics_results, x="Politics", y="labels", color="labels",
